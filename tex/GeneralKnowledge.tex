\chapter{Additional Useful Information}
	...
	\section{Linux}
		...
		\subsection{File Systems}
			...
			\index{Mounting}
				...
				\begin{adjustbox}{max width=1\textwidth}
					\begin{tabular}{l l l l l l }
						...
						%UUID=aeb6cbbf-f40c-4659-9d81-605e84467349 & / & btrfs & rw,relatime & 0 & 0 \\
			...
			\end{quote}
				...
				The Linux file structure is commonly throught of as a tree.
	...
	\index{Regex}
		...
		\subsection{Tools}
			...
			\subsubsection{Sed}
				...
				\end{minted}
				%TODO: Make this use regex specifically.
			\subsubsection{Vim}
