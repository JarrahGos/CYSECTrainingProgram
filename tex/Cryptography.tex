\chapter{Cryptography}
	...
	\section{Introduction to Cryptography}
		...
		\subsection{Types of Cryptography}
			...
			\index{Symmetric Key Cryptography}
		...
		\subsection{Basic Cryptography}
			...
			\index{Columnar Transportation Cipher}
	...
	\section{Poor Cryptography Implementations}
		...
		\index{Key Generation}
			...
			\index{Debian Weak RNG and Keys}
			...
			\subsubsection{Mask Attack}
				...
				\begin{adjustbox}{max width=1\textwidth}
					\begin{tabular}{ll}
						...
						?d & 0123456789 \\
						?s & <space>!"\#\$\%\&\verb!'()*+,-./:;<=>?@[\]\^_`{|}~}! \\
						%?s & Special Characters \\ %TODO: Have this print the characters.
						?a & \verb+?l?u?d?s+ \\
						?b & 0x00 - 0xff \\
						\bottomrule
					\end{tabular}
	...
	\section{Challenges}
		\subsection{Hash Challenges}
			...
			\mintinline[firstline=1,lastline=4]{console}{./shellOut/hashChallenges.data}
			...
			\mintinline[firstline=6,lastline=6]{console}{./shellOut/hashChallenges.data}
			...
			\mintinline[firstline=8,lastline=8]{console}{./shellOut/hashChallenges.data}
