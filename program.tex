...
\chapter{Wireless Attacks}
	...
	\section{Aircrack-ng}
		...
		\subsection{Sniffing a Network}
			The first step to a wireless attack is to gather dat about the potential target. 
		...
		\subsection{Active Attacks}
			...
			When the ARP packet is received, aireplay-ng will repeat it back at the AP continously, causing the traffic on the network to increase, thus collecting more IVs. 
