...
\chapter{Programming}
	...
	\section{Introduction to the CLI}
		...
		Others such as powershell on windows and Zsh on \**nix are not to be discounted, but bash will get you the furthest with minimal training.\footnote{\url{http://cli.learncodethehardway.org/book/}}  
