		...
		\subsection{Linux Commands}
			...
			\begin{table}[htb]
				...
				\begin{tabular}{| p{2.5cm} | p{3cm} | p{3cm} | p{3cm} |}
					\hline
					\multicolumn{1}{|c|}{\textbf{Command}} & \multicolumn{2}{| c |}{\textbf{Arguments}}  & \multicolumn{1}{|c|}{\textbf{Other}}
					\\ \hline
			...
			\begin{table}[htb]
				...
				\end{tabular}
				\label{tab:LinuxCommandsSummary}
				\caption{Basic Command Reference for Linux}
			\end{table}
