		...
		\subsection{Linux Commands}
			...
			\begin{table}[htb]
				...
				\begin{tabular}{| p{2.5cm} | p{3cm} | p{3cm} | p{3cm} |}
					\hline
					\textbf{Command} & \multicolumn{2}{| c |}{Arguments}  & Other \\ \hline
					& \textbf{Flags} & \textbf{Data} & \\ \hline
			...
			\begin{table}[htb]
				...
				\begin{tabular}{| p{3cm} | p{7cm} |} 
					\hline
					\textbf{Key Combination} & \textbf{Function} \\ \hline
					...
					\keys{\shift + Page Up} or \keys{\shift + Page Down} & Browse terminal buffer (See text that has been scrolled off screen. \\ \hline
