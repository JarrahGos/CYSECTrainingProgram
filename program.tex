	...
	\section{Linux}
		...
		\subsection{Terminology}
			...
			\begin{description}
				...
				\item[Filesystem] The system that file storage works on. 
				\begin{description}
					...
					\item[/dev] A virtual filesystem which gives the OS pointers to certain devices. 
						\begin{itemize}
					...
					\item[/sbin] /bin, but for system binaries
