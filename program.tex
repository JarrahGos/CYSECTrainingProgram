...
\chapter{The Cyber Range}
	Before starting to apply the skills given in the following chapters, it would be best to set up an area where you can practice without fear of accidental misfortune. 
	...
	\section{Challenges}
		\subsection{Building a Router}
			...
			\subsection{Set up NAT}
				...
				\lstinputlisting[numbers=none]{./shellOut/iptablesNat.in}
...
\chapter{Network Penetration}
	...
	\section{Nmap}
		...
		\subsection{SYN Scanning}
			...
			\lstinputlisting[numbers=none]{./shellOut/nmapSYN.out}
