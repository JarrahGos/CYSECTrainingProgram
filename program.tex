...
\chapter{System Hardening}
	...
	\section{Linux Hardening}\cite{FedoraSecGuide}
		\subsubsection{Passwords} 
			Your password\footnote{\url{https://wiki.archlinux.org/index.php/Security}} are the key to having a secure system. 
	...
	\section{Windows Hardening}
		Can Windows even be hardened? The answer is yes, But not in the same way as Linux or Mac OS X.
		...
		While these mitigations are a significant improvement from a default windows install, it is far more difficult to secure a home windows install than to secure a Mac OS X or Linux install. 
...
0x0000000100000efe <+46>:	lea    rdi,[rip+0x6f]        # 0x100000f74
...
0x0000000100000f14 <+68>:	lea    rdi,[rip+0x68]        # 0x100000f83
...
0x0000000100000f2c <+92>:	ret
	...
	\section{Challenges}
		...
		\begin{code}
			\lstinputlisting{./OverflowChallenge.c}
