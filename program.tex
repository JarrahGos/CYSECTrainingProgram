	...
	\section{Programming Challenges}
		\subsection{Linux Challenges}
			...
			\subsubsection{Hard Course: Setting up a VM and installing Kali Rolling}
				...
				With properly configured VMs and virtual networks, you cannot attack the wrong target, but without them, a single mistype and you could be attacking a completely different target. 
