...
\chapter{Network Operations}
	...
	\section{TCP/IP Model}
		%TODO: Add in this section and revise OSI based on CCNA/CCENT Book. 
		Much like the OSI Model, the TCP/IP model was created in order to standardise the way that computers communicate. 
