...
\chapter{Summary}
	...
	However, CTFs such as the Boston Key Party and Plaid CTF have also been analysed for use when the VECC gains a higher level of skill. 
	These two, in the order that they have been broken down are good higher level challenges for next year, when there are a number of members who have some experience with the activity. 
